...
if (isset($_GET['ml']) && $_GET['ml'] != 0) {
    ...
    $gt = $_GET['gt'];
    $gc = $_GET['gc'];
    $sql .= " WHERE don_gia >= :gt AND don_gia <= :gc";
    $params[':gt'] = $gt;
    $params[':gc'] = $gc;
}

// Prepare and execute the query to get the total count of products
$sta = $pdo->prepare($sql);
$sta->execute($params);
...
// Remove :vt and :limit from params and bind values directly
unset($params[':vt']);
unset($params[':limit']);
    ...
    <section class="main_content">
            ...
            <div class="container_slider">
                <div class="slider_content">
                    ...
                    <div class="slider_content_right">
                        ...
                        <div class="img"><a href="#"><img src="./Images_Logo/img3.webp" alt=""></a></div>
        ...
        <section>
            ...
            <div class="menu_mua_theo_nhu_cau">
                <ul>
                    <li><a href="./SanPhamTheoGia.php?gt=0&gc=2000000">Dưới 2 triệu</a></li>
